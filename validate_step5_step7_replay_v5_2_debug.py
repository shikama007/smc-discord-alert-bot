...
def main():
    ...
    for n in range(start, end):
        ...
        try:
            # Use the exact production Step 5 -> Step 8 pipeline.
            # The production engine does NOT call get_step5_status(df, bias).
            # It first builds structure/POIs/sweeps, then passes:
            #   get_step5_status(sweeps, bias, preferred_pois, events)
            #   get_step6_status(df, step5, bias)
